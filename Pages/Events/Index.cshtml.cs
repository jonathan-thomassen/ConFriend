...
namespace ConFriend.Pages.Events
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(ICrudService<Event> eventService, ICrudService<Room> roomService, ICrudService<Speaker> speakerService, ICrudService<Conference> conferenceService, ICrudService<Venue> venueService)
        {
